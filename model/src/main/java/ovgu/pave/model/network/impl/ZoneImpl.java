 ...
 * </p>
 * <ul>
 *   <li>{@link ovgu.pave.model.network.impl.ZoneImpl#getId <em>Id</em>}</li>
 *   <li>{@link ovgu.pave.model.network.impl.ZoneImpl#getLocations <em>Locations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ZoneImpl extends MinimalEObjectImpl.Container implements Zone {
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NetworkPackage.ZONE__ID, oldId, id));
	}
	...
	public EList<Location> getLocations() {
		if (locations == null) {
			locations = new EObjectResolvingEList<Location>(Location.class, this, NetworkPackage.ZONE__LOCATIONS);
		}
		return locations;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NetworkPackage.ZONE__ID:
				return getId();
			case NetworkPackage.ZONE__LOCATIONS:
				return getLocations();
		}

...
public class ConfigAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConfigSwitch<Adapter> modelSwitch =
		new ConfigSwitch<Adapter>() {
			...
			@Override
			public Adapter caseRequestConstraints(RequestConstraints object) {
				return createRequestConstraintsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ovgu.pave.model.config.Scenario <em>Scenario</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ovgu.pave.model.config.RequestConstraints <em>Request Constraints</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRequestConstraintsAdapter() {
		return null;
	}

 ...
 *   <li>{@link ovgu.pave.model.input.impl.RequestImpl#getMaxDrivingDuration <em>Max Driving Duration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequestImpl extends MinimalEObjectImpl.Container implements Request {
	...
	/**
	 * The default value of the '{@link #getMaxDrivingDuration() <em>Max Driving Duration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final long MAX_DRIVING_DURATION_EDEFAULT = -1L;

	/**
	 * The cached value of the '{@link #getMaxDrivingDuration() <em>Max Driving Duration</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getMaxDrivingDuration()
	 * @generated
	 * @ordered
	 */
	protected long maxDrivingDuration = MAX_DRIVING_DURATION_EDEFAULT;
	 ...
	 * @generated
	 */
	public long getMaxDrivingDuration() {
		return maxDrivingDuration;
	}
	 ...
	 * @generated
	 */
	public void setMaxDrivingDuration(long newMaxDrivingDuration) {
		long oldMaxDrivingDuration = maxDrivingDuration;
		maxDrivingDuration = newMaxDrivingDuration;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InputPackage.REQUEST__MAX_DRIVING_DURATION, oldMaxDrivingDuration, maxDrivingDuration));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case InputPackage.REQUEST__QUANTITY:
				return getQuantity();
			case InputPackage.REQUEST__MAX_DRIVING_DURATION:
				return getMaxDrivingDuration();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case InputPackage.REQUEST__QUANTITY:
				...
				return;
			case InputPackage.REQUEST__MAX_DRIVING_DURATION:
				setMaxDrivingDuration((Long)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case InputPackage.REQUEST__QUANTITY:
				...
				return;
			case InputPackage.REQUEST__MAX_DRIVING_DURATION:
				setMaxDrivingDuration(MAX_DRIVING_DURATION_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case InputPackage.REQUEST__MAX_DRIVING_DURATION:
				return maxDrivingDuration != MAX_DRIVING_DURATION_EDEFAULT;
		}
	...
	public String toString() {
		...
		result.append(quantity);
		result.append(", maxDrivingDuration: ");
		result.append(maxDrivingDuration);
		result.append(')');

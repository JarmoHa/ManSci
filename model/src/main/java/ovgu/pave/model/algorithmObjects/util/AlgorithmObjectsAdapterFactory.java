...
public class AlgorithmObjectsAdapterFactory extends AdapterFactoryImpl {
	...
	protected AlgorithmObjectsSwitch<Adapter> modelSwitch =
		new AlgorithmObjectsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDrivingTimeInformation(DrivingTimeInformation object) {
				return createDrivingTimeInformationAdapter();
			}
			@Override
			public Adapter caseSlacks(Slacks object) {
				return createSlacksAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ovgu.pave.model.algorithmObjects.DrivingTimeInformation <em>Driving Time Information</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDrivingTimeInformationAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link ovgu.pave.model.algorithmObjects.Slacks <em>Slacks</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSlacksAdapter() {
		return null;
	}
